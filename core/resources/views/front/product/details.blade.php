                ...
                <div class="col-lg-5 col-md-6">
                    <div class="shop-content pt-60">
                        ...
                        <div class="shop-price pt-15">
                            <ul>
                                <li>{{$be->base_currency_symbol_position == 'left' ? $be->base_currency_symbol : ''}}{{convertUtf8(number_format($product->current_price,0,',','.'))}}{{$be->base_currency_symbol_position == 'right' ? $be->base_currency_symbol : ''}}</li>
                                @if(convertUtf8(number_format($product->previous_price,0,',','.')))
                                <li>{{$be->base_currency_symbol_position == 'left' ? $be->base_currency_symbol : ''}}{{convertUtf8(number_format($product->previous_price,0,',','.'))}}{{$be->base_currency_symbol_position == 'right' ? $be->base_currency_symbol : ''}}</li>
                                @endif
                            </ul>
                                ...
                                <div class="shop-review-area">
                                    <div class="shop-review-title">
                                        ...
                                        <div class="shop-review-user">
                                            <img  src="{{ !empty($review->user->photo) ? asset('assets/front/img/user/'.$review->user->photo) : asset('assets/front/img/user/profile-user.png') }}" width="60">
                                            <ul>
                                                <div class="rate">
                                                    <div class="rating" style="width:{{$review->review * 20}}%"></div>
                                                </div>
                                            </ul>
                                            <span><span>{{!empty(convertUtf8($review->user->username)) ? convertUtf8($review->user->username) : convertUtf8($review->user->number)}}</span> – {{$review->created_at->format('d/m/Y')}}</span>
