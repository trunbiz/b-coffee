               ...
               <form action="{{route('admin.updateProfile')}}" method="post" role="form" enctype="multipart/form-data">
                 ...
                 <div class="form-body">
                    ...
                    <div class="form-group">
                       ...
                       <div class="col-md-12">
                          <input class="form-control input-lg" name="username" value="{{$admin->username}}" placeholder="{{__('Your Username')}}" type="text">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-12">
                           <input class="form-control input-lg" name="email" value="{{$admin->email}}" placeholder="{{__('Your Email')}}" type="text">
                           @if ($errors->has('email'))
                    ...
                    <div class="form-group">
                       ...
                       <div class="col-md-12">
                          <input class="form-control input-lg" name="first_name" value="{{$admin->first_name}}" placeholder="{{__('Your First Name')}}" type="text">
                    ...
                    <div class="form-group">
                      <div class="col-md-12">
                       ...
                       <div class="col-md-12">
                          <input class="form-control input-lg" name="last_name" value="{{$admin->last_name}}" placeholder="{{__('Your Last Name')}}" type="last_name">
