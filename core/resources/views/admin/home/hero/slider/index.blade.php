      ...
      <div class="col-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-lg-10">
                        <div class="card-title">{{__('Images')}}</div>
                    </div>
                    <div class="col-lg-2">
                        @if (!empty($langs))
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      <div class="col-6 mb-2">
                        <label for="image"><strong> {{__('Shape Image')}}</strong></label>
                      </div>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      <div class="col-6 mb-2">
                        <label for="image"><strong> {{__('Bottom Image')}}</strong></label>
                      </div>
        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-4 offset-lg-4 mt-2 mt-lg-0">
                    <a href="#" class="btn btn-primary float-lg-right float-left" data-toggle="modal" data-target="#createModal"><i class="fas fa-plus"></i> {{__('Add Slider')}}</a>
                </div>
            </div>
        </div>
        <div class="card-body">
        ...
        <div class="modal-body">
          <form class="modal-form" id="ajaxForm" action="{{route('admin.slider.store')}}" method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="text" value="" placeholder="{{__('Enter Text')}}">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="button_text1"  placeholder="{{__('Enter Button Text')}}">
              <p id="errbutton_text1" class="text-danger mb-0 em"></p>
            </div>
            <div class="form-group">
              <label for="">{{__('Button URL 2')}}</label>
              <input type="text" class="form-control ltr" name="button_url1"  placeholder="{{__('Enter Button URL')}}">
