              ...
              <form id="ajaxForm" class="" action="{{route('admin.slider.update')}}" method="post">
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      <div class="col-12 mb-2">
                        <label for="image"><strong>{{__('Slider Image')}}</strong></label>
                      </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      <div class="col-12 mb-2">
                        <label for="image"><strong> {{__('Backgraound Image')}}</strong></label>
                      </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="title" value="{{$slider->title}}" placeholder="{{__('Enter Title')}}">
                  <p id="errtitle" class="text-danger mb-0 em"></p>
                </div>
                <div class="form-group">
                  <label>{{__('Title Color Code')}} **</label>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="text" value="{{$slider->text}}" placeholder="{{__('Enter Text')}}">
                  <p id="errtext" class="text-danger mb-0 em"></p>
                </div>
                <div class="form-group">
                  <label>{{__('Text Color Code')}} **</label>
                  <input class="jscolor form-control ltr" name="text_color" value="{{$slider->text_color}}">
                  <p id="text_color" class="mb-0 text-danger em"></p>
                </div>
                <div class="form-group">
                  <label for="">{{__('Button Text 1')}}</label>
                  <input type="text" class="form-control" name="button_text" value="{{$slider->button_text}}" placeholder="{{__('Enter Button Text')}}">
                  <p id="errbutton_text" class="text-danger mb-0 em"></p>
                </div>
                <div class="form-group">
                  <label for="">{{__('Button URL 1')}}</label>
                  <input type="text" class="form-control ltr" name="button_url" value="{{$slider->button_url}}" placeholder="{{__('Enter Button URL')}}">
                  <p id="errbutton_url" class="text-danger mb-0 em"></p>
                </div>
                <div class="form-group">
                  <label for="">{{__('Button Text 2')}}</label>
                  <input type="text" class="form-control" name="button_text1" value="{{$slider->button_text1}}" placeholder="{{__('Enter Button Text')}}">
                  <p id="errbutton_text1" class="text-danger mb-0 em"></p>
                </div>
                <div class="form-group">
                  <label for="">{{__('Button URL 2')}}</label>
                  <input type="text" class="form-control ltr" name="button_url1" value="{{$slider->button_url1}}" placeholder="{{__('Enter Button URL')}}">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control ltr" name="serial_number" value="{{$slider->serial_number}}" placeholder="{{__('Enter Serial Number')}}">
