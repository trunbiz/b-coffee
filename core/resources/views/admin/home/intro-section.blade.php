          ...
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              ...
              <form id="ajaxForm" action="{{route('admin.introsection.update', $lang_id)}}" method="post">
                ...
                <div class="form-group">
                  <label for="">{{__('Section Title')}}</label>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      <div class="col-12 mb-2">
                        <label for="image"><strong>{{__('Signature')}}</strong></label>
                      </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      <div class="col-12 mb-2">
                        <label for="image"><strong>{{__('Video Backgraound')}}</strong></label>
                      </div>
                ...
                <div class="form-group">
                  <label for="">{{__('Contact Text')}} </label>
