    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-10">
                    <div class="card-title">{{__('Title & Subtitle')}}</div>
                </div>
                <div class="col-lg-2">
                    @if (!empty($langs))
      ...
      <div class="card">
        <div class="card-header">
          ...
          <a href="{{route('admin.member.create') . '?language=' . request()->input('language')}}" class="btn btn-primary float-right"><i class="fas fa-plus"></i> {{__('Add Member')}}</a>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <select class="form-control {{$member->feature == 1 ? 'bg-success' : 'bg-danger'}}" name="feature" onchange="document.getElementById('featureForm{{$member->id}}').submit();">
                                <option value="1" {{$member->feature == 1 ? 'selected' : ''}}>{{__('Yes')}}</option>
                                <option value="0" {{$member->feature == 0 ? 'selected' : ''}}>{{__('No')}}</option>
                            </select>
                            </form>
                          </td>
                          <td>
