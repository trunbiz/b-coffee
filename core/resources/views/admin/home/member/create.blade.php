    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">{{__('Add Member')}}</div>
            ...
            <div class="col-lg-6 offset-lg-3">
              ...
              <form id="ajaxForm" class="" action="{{route('admin.member.store')}}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control ltr" name="facebook" value="" placeholder="{{__('Enter facebook url')}}">
                  <p id="errfacebook" class="mb-0 text-danger em"></p>
                </div>
                <div class="form-group">
                  <label for="">{{__('Twitter')}}</label>
                  <input type="text" class="form-control ltr" name="twitter" value="" placeholder="{{__('Enter twitter url')}}">
                  <p id="errtwitter" class="mb-0 text-danger em"></p>
                </div>
                <div class="form-group">
                  <label for="">{{__('Instagram')}}</label>
                  <input type="text" class="form-control ltr" name="instagram" value="" placeholder="{{__('Enter instagram url')}}">
                  <p id="errinstagram" class="mb-0 text-danger em"></p>
                </div>
                <div class="form-group">
                  <label for="">{{__('Linkedin')}}</label>
                  <input type="text" class="form-control ltr" name="linkedin" value="" placeholder="{{__('Enter linkedin url')}}">
