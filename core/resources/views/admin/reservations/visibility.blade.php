...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{__('Reservations Page Visibility')}}</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">{{__('Reservations Management')}}</a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
      <li class="nav-item">
        <a href="#">{{__('Reservations Page Visibility')}}</a>
      </li>
    </ul>
  </div>
  <div class="row">
      ...
      <div class="card">
        <form action="{{route('admin.reservations.visibility.update')}}" method="post">
          ...
          <div class="card-header">
              <div class="row">
                  <div class="col-lg-12">
                      <div class="card-title">{{__('Reservations Page Visibility')}}</div>
                  </div>
              </div>
          </div>
            ...
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                ...
                <div class="form-group">
                  <label>{{__('Request a Reservations Page Status')}} **</label>
