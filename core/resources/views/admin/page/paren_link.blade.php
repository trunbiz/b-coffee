...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{__('Pages Parent Link')}}</h4>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
              <div class="col-lg-4">
                  <div class="card-title d-inline-block">{{__('Pages Parent Link')}}</div>
              </div>
              <div class="col-lg-3">
                @if (!empty($langs))
                ...
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <div class="form-group">
                      <label for="">{{__('Link Title')}} **</label>
                      <input type="text" name="link" class="form-control" placeholder="{{__('Enter parent link')}}" value="{{$abs->pages_p_link}}">
