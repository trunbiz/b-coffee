                    ...
                    <tbody>
                      @foreach ($users as $key => $user)
                        <tr>
                          ...
                          <td><img src="{{$user->photo ? asset('assets/front/img/user/'.$user->photo) : ''}}" alt="" style="width: 60px;"></td>
                          <td>
                             {{$user->number}}
                          </td>
                          ...
                          <td>
                            <a  href="{{route('register.user.view',$user->id)}}" class="btn btn-primary btn-sm editbtn"><i class="fas fa-eye"></i> {{__('View')}}</a>
                          </td>
                          <td>
