...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{__('Gallery Images')}}</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">{{__('Gallery Image Management')}}</a>
      </li>
    </ul>
  </div>
  <div class="row">
        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                    <a href="#" class="btn btn-primary float-right btn-sm" data-toggle="modal" data-target="#createModal"><i class="fas fa-plus"></i> {{__('Add Image')}}</a>
                    <button class="btn btn-danger float-right btn-sm mr-2 d-none bulk-delete" data-href="{{route('admin.gallery.bulk.delete')}}"><i class="flaticon-interface-5"></i> {{__('Delete')}}</button>
                </div>
            </div>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              @if (count($galleries) == 0)
                <h3 class="text-center">{{__('NO IMAGE FOUND')}}</h3>
              @else
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">{{__('Add Image')}}</h5>
        ...
        <div class="modal-body">
          <form id="ajaxForm" class="modal-form" action="{{route('admin.gallery.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <p class="text-warning"><small>{{__('The higher the serial number is, the later the image will be shown.')}}</small></p>
            </div>
          </form>
        </div>
