...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{__('Edit Gallery')}}</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">{{__('Gallery Page')}}</a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
      <li class="nav-item">
        <a href="#">{{__('Edit Gallery')}}</a>
      </li>
    </ul>
  </div>
  <div class="row">
            ...
            <div class="col-lg-6 offset-lg-3">
              ...
              <form id="ajaxForm" class="" action="{{route('admin.gallery.update')}}" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="title" value="{{$gallery->title}}" placeholder="{{__('Enter title')}}">
                  <p id="errtitle" class="mb-0 text-danger em"></p>
                </div>
                <div class="form-group">
                  <label for="">{{__('Serial Number')}} **</label>
                  <input type="number" class="form-control ltr" name="serial_number" value="{{$gallery->serial_number}}" placeholder="{{__('Enter Serial Number')}}">
