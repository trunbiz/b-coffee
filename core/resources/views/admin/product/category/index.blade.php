...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{__('Product Categories')}}</h4>
        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                    <a href="#" class="btn btn-primary float-right btn-sm" data-toggle="modal" data-target="#createModal"><i class="fas fa-plus"></i> {{__('Add Category')}}</a>
